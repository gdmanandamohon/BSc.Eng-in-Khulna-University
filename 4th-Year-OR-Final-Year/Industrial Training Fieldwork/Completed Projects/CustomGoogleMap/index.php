        ...
        $(document).ready(function() {
            ...
            function map_initialize()
            {
                    ...
                    google.maps.event.addListener(map, 'rightclick', function(event) {
                        ...
                        '<label for="pReign"><span>Reign :</span> <select name="pReign" class="save-reign"><option value="dhaka">Dhaka</option><option value="khulna">Khulna</option>'+
            ...
            function create_marker(contact,MapPos, MapTitle, MapDesc,  InfoOpenDefault, DragAble, Removable, iconPath)
            {
                ...
                if(typeof saveBtn !== 'undefined') //continue only when save button is present
                {
                    ...
                    google.maps.event.addDomListener(saveBtn, "click", function(event) {
                        ...
                        var mReign = contentString.find('select.save-reign')[0].value;
                        alert(mReign);
